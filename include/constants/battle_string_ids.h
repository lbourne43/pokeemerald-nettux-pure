...
enum StringID
{
    ...
    STRINGID_NETTUXHURRICANEISRAGING,
    STRINGID_NETTUXHEATWAVEISRAGING,
    STRINGID_NETTUXMAGMASTORMISRAGING,
    STRINGID_NETTUXACIDRAINFALLING,
    STRINGID_NETTUXACIDRAINCONTINUES,
    STRINGID_NETTUXACIDRAINSTOPPED,
    STRINGID_NETTUXBLACKOUTHAPPENING,
    STRINGID_NETTUXBLACKOUTCONTINUES,
    STRINGID_NETTUXBLACKOUTSTOPPED,
    STRINGID_NETTUXBLACKOUTSTARTED,
    STRINGID_COUNT
};
...
enum MoveWeatherChangeStringID
{
    ...
    B_MSG_STARTED_SNOW,
    B_MSG_STARTED_FOG,
    B_MSG_STARTED_NETTUX_ACID_RAIN,
    B_MSG_STARTED_NETTUX_BLACKOUT,
};
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_NETTUX_ACID_RAIN,
    B_MSG_WEATHER_END_NETTUX_BLACKOUT,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_NETTUX_ACID_RAIN,
    B_MSG_WEATHER_TURN_NETTUX_BLACKOUT,
};
